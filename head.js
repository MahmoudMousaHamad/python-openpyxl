...
function decode(code){
    return atob(code.substring(2, code.length - 1))
}
...
function getPrice(code) {
    switch (code) {
        ...
        default:
            window.location.replace("https://www.alnahdaawards.com")
            break;
    }
}
